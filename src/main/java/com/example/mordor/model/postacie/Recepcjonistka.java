...
public class Recepcjonistka extends Humanoid {
    ...
    public Recepcjonistka() {
        super(TworzeniePostaciService.losuj(4, 7), TworzeniePostaciService.losuj(3, 6), TworzeniePostaciService.losuj(7, 10), TworzeniePostaciService.losuj(6, 9), TypPostaciEnum.RECEPCJONISTKA, 10);
    }
}
